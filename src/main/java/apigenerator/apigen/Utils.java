...
public class Utils {
    ...
    public static void generateDaoClass(String entityName, String author, int nrQueryParam) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(entityName+"Dao.java"));
        writer.write(getDaoJavaFile(entityName, author, nrQueryParam));
        writer.close();
    }

    public static void generateServiceClass(String entityName, String author, int nrQueryParam) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(entityName+"Service.java"));
        writer.write(getServiceJavaFile(entityName, author, nrQueryParam));
        writer.close();
    }

    public static void generateDaoImplClass(String entityName, String author, int nrOfQueryParams) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(entityName+"DaoImpl.java"));
        writer.write(getDaoImplJavaFile(entityName, author, nrOfQueryParams));
        writer.close();
    }

    public static void generateServiceImplClass(String entityName, String author, int nrOfQueryParams) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(entityName+"ServiceImpl.java"));
        writer.write(getServiceImplJavaFile(entityName, author, nrOfQueryParams));
        writer.close();
    }

    public static void generateControllerClass(String entityName, String author, int nrOfQueryParams) throws IOException {
        BufferedWriter writer = new BufferedWriter(new FileWriter(entityName+"Controller.java"));
        writer.write(getControllerJavaFile(entityName, author, nrOfQueryParams));
        writer.close();
    }
